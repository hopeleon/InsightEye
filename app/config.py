...
REALTIME_DISC_PROMPT_PATH = PROMPTS_DIR / "realtime_disc_prompt.txt"
...
DEFAULT_OPENAI_REALTIME_DISC_MODEL = "gpt-5-mini"
...
OPENAI_REALTIME_DISC_MODEL = str(local_settings.get("OPENAI_REALTIME_DISC_MODEL", os.getenv("OPENAI_REALTIME_DISC_MODEL", DEFAULT_OPENAI_REALTIME_DISC_MODEL))).strip()
